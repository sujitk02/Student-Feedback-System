...
$sql=mysqli_query($conn,"select * from feedback where student_id='$user' and subject='$subj'");
...
{
$query="insert into feedback values('','$nm','$user','$faculty','$subj','$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9','$quest10','$quest11','$quest12','$quest13','$quest14',now())";
...
<td>
<select name="faculty" id="facultyid" class="form-control" onChange="showUser(this.value)">
